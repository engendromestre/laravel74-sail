...
<template>
    <button @click="toogleDark()" type="button" class="text-xs text-gray-500 
                                                dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 
